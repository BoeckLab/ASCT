...
# Aim
# ================================================================
# Validate the performance of the ilastik-based PI-positivity classifier
# by comparing predicted labels against manually curated ground truth
# and quantifying:
#   - confusion matrix metrics (accuracy, sensitivity, specificity, etc.),
#   - ROC curve and AUC,
#   - precision–recall behaviour across decision thresholds.
#
# Functionality:
# - Loads ground-truth PI labels (User.Label) and corresponding ASCT
#   model predictions on matched single-cell objects.
# - Exports a list of all discrepant annotations for manual re-checking.
# - Computes full caret confusion matrix statistics and writes a
#   text report.
# - Generates ROC and precision–recall curves with AUC / threshold sweep
#   to characterise classifier robustness.
