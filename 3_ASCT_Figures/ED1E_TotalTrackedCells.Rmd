...
# Aim
# ================================================================
# Quantify the coverage of the ASCT tolerance experiments in terms of
# tracked single cells.
#
# This script:
# - Loads per-well tracking output files (_Trkv2_LC.N.csv) for all
#   selected ASCT experiments.
# - Sums the number of tracked cells per well at t = 0, then aggregates
#   per experiment and across the full dataset.
# - Merges per-well counts with the global QC table to distinguish
#   growth-excluded wells from analysis-included wells.
# - Visualises:
#     (i) histograms of tracked cells per well (growth-excluded vs
#         analysis-included),
#     (ii) histograms of total tracked cells per isolate–drug pair,
#         including labelling of the highest-coverage conditions.
# - Reports total, per-experiment, and per-well tracked cell
#   numbers for the ASCT tolerance screen.
