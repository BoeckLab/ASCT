...
# Aim
# ================================================================
# This script visualises ASCT time-kill curves and their endpoint
# distributions across isolates and drug conditions.
#
# Functionality:
# - Loads per-isolate time-kill curve summaries and AUC phenotypes.
# - Harmonises isolate and drug labels (ATCC, OM isolates, FOX/IPM, etc.).
# - For each antibiotic condition, plots:
#     • All single-isolate time-kill curves (LCF vs time)
#     • A histogram + density of live-cell fraction at 72 h.
# - Exports per-drug PDF pages and combined figure layouts
#   for manuscript panels (main drugs & FOX/IPM subsets).
